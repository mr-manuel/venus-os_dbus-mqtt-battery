...
cp $SCRIPT_DIR/qml/PageBattery.qml /opt/victronenergy/gui/qml/
# copy new PageBatteryCellVoltages
cp $SCRIPT_DIR/qml/PageBatteryCellVoltages.qml /opt/victronenergy/gui/qml/
# copy new PageBatterySetup
cp $SCRIPT_DIR/qml/PageBatterySetup.qml /opt/victronenergy/gui/qml/
# copy new PageLynxIonIo.qml
cp $SCRIPT_DIR/qml/PageLynxIonIo.qml /opt/victronenergy/gui/qml/
